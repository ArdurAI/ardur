---
title: "OpenAI Agents SDK + Ardur no-key fixture"
description: "Runnable today without an OpenAI API key. This directory contains an offline"
...
{{< proof-status state="public" label="Source-backed mirror" source="examples/openai-agents-sdk/README.md" >}}
