...
{{< proof-status state="public" label="Source-backed mirror" source="examples/autogen-quickstart/README.md" >}}
...
The protocol-only flow is in [`examples/missions/`](/__ardur_internal__/source/examples/missions/).
