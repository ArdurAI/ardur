---
title: "MCP Gateway"
description: "The MCP Gateway sits between an MCP client (e.g. Claude Desktop) and an"
source_path: "docs/guides/mcp-gateway.md"
source_sha256: "31927ce84372551054419434030b8accb64c9971e04b19b0a2ceb17e5c9710f5"
weight: 100
maturity: ["public-now"]
...
{{< proof-status state="public" label="Source-backed mirror" source="docs/guides/mcp-gateway.md" >}}
...
Source: [`python/vibap/mcp_gateway.py`](https://github.com/ArdurAI/ardur/blob/__ARDUR_SOURCE_REF__/python/vibap/mcp_gateway.py).
