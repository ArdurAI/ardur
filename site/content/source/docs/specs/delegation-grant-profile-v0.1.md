...
{{< proof-status state="public" label="Source-backed mirror" source="docs/specs/delegation-grant-profile-v0.1.md" >}}
...
> is in [`docs/specs/README.md`](/__ardur_internal__/source/docs/specs/readme/). Some companion specs have not
