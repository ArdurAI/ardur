...
{{< proof-status state="public" label="Source-backed mirror" source="docs/articles/06-public-import-discipline.md" >}}
...
> [`docs/public-import-plan.md`](/__ardur_internal__/source/docs/public-import-plan/),
> [`README.md` naming note](/__ardur_internal__/source/readme/),
...
1. **Pass 1 — sensitive-reference scrub.** Patterns covering
   ...
   in
   [`docs/public-import-plan.md`](/__ardur_internal__/source/docs/public-import-plan/)'s
...
[`docs/public-import-plan.md`](/__ardur_internal__/source/docs/public-import-plan/) and
[`README.md`](/__ardur_internal__/source/readme/). Comments and corrections via
GitHub Discussions.*
