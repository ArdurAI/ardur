...
{{< proof-status state="public" label="Source-backed mirror" source="docs/comparisons/hook-evaluation-model.md" >}}
...
This is the case the [Tool Response Provenance](/__ardur_internal__/source/docs/specs/conformance-profiles-v0.1/) profile addresses. It's MIC-State conformance level — beyond what scope-only enforcement can express, but well-defined and implementable.
