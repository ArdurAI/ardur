...
{{< proof-status state="public" label="Source-backed mirror" source="AGENTS.md" >}}
...
[`CONTRIBUTING.md`](/__ardur_internal__/source/contributing/) and
[`docs/engineering-standards.md`](/__ardur_internal__/source/docs/engineering-standards/); this file
...
[`docs/known-limitations.md`](/__ardur_internal__/source/docs/known-limitations/) and
[`STATUS.md`](/__ardur_internal__/source/status/). Those files win over this summary.
...
Report vulnerabilities through [`SECURITY.md`](/__ardur_internal__/source/security/) — a GitHub Security
...
is a human judgment call by the maintainer. See [`GOVERNANCE.md`](/__ardur_internal__/source/governance/).
