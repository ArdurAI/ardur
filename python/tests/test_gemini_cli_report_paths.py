...
@pytest.mark.parametrize(
    ...
    [
        ("--home", "", "gemini_cli_report_home_empty"),
        ("--home", "   ", "gemini_cli_report_home_empty"),
        ("--chain-dir", "", "gemini_cli_report_chain_dir_empty"),
        ("--chain-dir", "   ", "gemini_cli_report_chain_dir_empty"),
        ("--keys-dir", "", "gemini_cli_report_keys_dir_empty"),
        ("--keys-dir", "   ", "gemini_cli_report_keys_dir_empty"),
    ],
)
def test_gemini_cli_report_rejects_empty_or_whitespace_path_args(
    ...
    rc = main(["gemini-cli-report", "--json", option, value])
